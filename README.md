...
Information and reflection about the planned path can be found below under "Details of my implementation"
...
The goal of safely navigating can be met as shown in the picture below. The highest score (before closing the program) was 8 Miles in 10:43min.
